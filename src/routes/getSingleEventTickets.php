...
$app->post('/api/LondonTheatreDirect/getSingleEventTickets', function ($request, $response) {
    ...
    $validateRes = $checkRequest->validate($request, ['apiKey', 'eventId', 'dateFrom', 'dateTo', 'nbOfTickets']);
