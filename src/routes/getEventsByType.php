...
$app->post('/api/LondonTheatreDirect/getEventsByType', function ($request, $response) {
    ...
    $validateRes = $checkRequest->validate($request, ['apiKey', 'eventTypeId']);
    ...
    try {
        ...
        $vendorResponse = $client->get($url, [
            ...
            'query' => [
                'type' => $postData['args']['eventTypeId']
            ]
        ]);
