...
$app->post('/api/LondonTheatreDirect/getEventPerformancesByDate', function ($request, $response) {
    ...
    $validateRes = $checkRequest->validate($request, ['apiKey', 'eventId', 'dateFrom', 'dateTo']);
