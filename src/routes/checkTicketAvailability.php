...
$app->post('/api/LondonTheatreDirect/checkTicketAvailability', function ($request, $response) {
    ...
    $validateRes = $checkRequest->validate($request, ['apiKey', 'ticketId']);
    ...
    $url = $settings['apiUrl'] . "/TicketAvailability/" . $postData['args']['ticketId'];
