...
$app->post('/api/LondonTheatreDirect/getSingleVenueEvents', function ($request, $response) {
    ...
    $validateRes = $checkRequest->validate($request, ['apiKey', 'venueId']);
    ...
    $url = $settings['apiUrl'] . "/Venues/" . $postData['args']['venueId'] . "/Events";
