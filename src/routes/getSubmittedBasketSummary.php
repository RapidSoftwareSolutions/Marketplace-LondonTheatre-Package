...
$app->post('/api/LondonTheatreDirect/getSubmittedBasketSummary', function ($request, $response) {
    ...
    $url = $settings['apiUrl'] . "/Baskets/" . $postData['args']['basketId'] . "/SubmittedBasketSummary";
