...
$app->post('/api/LondonTheatreDirect/getSinglePerformance', function ($request, $response) {
    ...
    $validateRes = $checkRequest->validate($request, ['apiKey', 'performanceId']);
    ...
    $url = $settings['apiUrl'] . "/Performances/" . $postData['args']['performanceId'];
